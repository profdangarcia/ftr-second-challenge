...
/** Variantes de cor do Badge (exportadas para mapear cor da API, ex.: CategoryColor). */
...
export type BadgeColorVariant = (typeof BADGE_COLOR_VARIANTS)[number]

/** Converte string de cor (ex.: "BLUE" da API) para variante do Badge. */
export function getBadgeVariantFromColor(color: string): BadgeColorVariant {
  const lower = color.toLowerCase()
  return BADGE_COLOR_VARIANTS.includes(lower as BadgeColorVariant)
    ? (lower as BadgeColorVariant)
    : "default"
}
